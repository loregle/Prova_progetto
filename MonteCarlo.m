function [f,U,bins,edges] = MonteCarlo(U0M,beta,gamma,N,N_c,M) % U0M mi serve per avere la matrice di partenza
set(0,'DefaultTextInterpreter','latex')
rng(1)

a = U0M(:,N_c);
U1    = a(a~=0);clear a; % per farle interagire le divido in due gruppi
U1new = zeros(numel(U1),1);
Theta_b = binornd(1,beta,N,1);
Theta_g = binornd(1,gamma,N,1);
